...
var OrbitCamera = pc.createScript("orbitCamera", pc.Application.getApplication());
...
OrbitCamera.attributes.add("autoRender", {
  ...
  title: "Auto Render",
  description:
    "Disable to only render when camera is moving (saves power when the camera is still)",
});
