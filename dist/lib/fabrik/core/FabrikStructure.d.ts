...
export interface FabrikStructure<T extends FabrikChain<FabrikBone<V, J>, Vector<V>, FabrikJoint<J>>, V extends Vector<V>, J extends FabrikJoint<J>> {
    /**
     ...
     */
    connectChain(newChain: T, existingChainNumber: number, existingBoneNumber: number, boneConnectionPoint: BoneConnectionPoint): void;
    /**
